...
public class TeamController extends BaseController {
	...
	private void buildSearchResultsTableTeamDetail(Team team) {
		...
		header.append("<img id='logo' src='").append(view.getLogo(team.getName())).append("'").append(" alt='")
				.append(team.getName()).append("'").append(" />").append("<h1>").append(team.getName()).append("</h1>")
				.append("<h3>League - ").append(team.getLeague()).append("</h3>").append(team.getYearFounded())
				.append(" - ").append(team.getYearLast());
